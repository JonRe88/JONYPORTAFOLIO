        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#hero" className="text-2xl font-bold text-white">
              Jony<span className="text-indigo-400">Reyes</span>
            </a>
            <p className="mt-2 max-w-md">
              

Desarrollador frontend que crea experiencias digitales atractivas con código limpio y diseño reflexivo.
            </p>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <p>
              © {currentYear} Jony Reyes. All rights reserved.
            </p>
